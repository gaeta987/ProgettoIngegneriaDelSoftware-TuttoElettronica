		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="${pageContext.request.contextPath}/ImageProxyController?name=<%=prodotto.getImmagine()%>"></div>
				</div>
							...
							<form action="CartControl">
								...
								<div class="clearfix" style="z-index: 1000;">
									...
									<div class="product_quantity clearfix">
										...
										<input id="quantity_input" type="number" pattern="[0-9]*" value="1" name="quantity" max="<%=prodotto.getQuantitaInMagazzino()%>">							
									</div>
								</div>
