<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    ArrayList<ProdottoInMagazzinoBean> prodotti = (ArrayList<ProdottoInMagazzinoBean>)request.getAttribute("prodottiInMagazzino");
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						...
						for(ProdottoInMagazzinoBean b : prodotti){
						%>
								...
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										...
										<div class="cart_item_name cart_info_col">
											...
											<div class="cart_item_text"><%=b.getQuantitaInMagazzino() %></div>
										</div>
										<div class="cart_item_name cart_info_col">
										...
										<div class="cart_item_name cart_info_col">
											...
											<div class="cart_item_text"><%=b.isPromo() %></div>
										</div>
										<%
										if(!b.isPromo()){
										%>
										<div class="cart_item_name cart_info_col">
											...
											<div class="cart_item_text"><a href="GestisciPromozioneControl?id=<%=b.getIdProdotto()%>&action=add">Aggiungi In Promozione</a></div>
										</div>
										<%
										}else{
										%>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title"></div>
											<div class="cart_item_text"><a href="GestisciPromozioneControl?id=<%=b.getIdProdotto()%>&action=remove">Rimuovi Promozione</a></div>
										</div>
										<%
										}
										%>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title"></div>
											<div class="cart_item_text"><a href="GestisciProdottiControl?id=<%=b.getIdProdotto()%>&action=delete">Elimina</a></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title"></div>
											<div class="cart_item_text"><a href="VisualizzaModificheProdottoControl?id=<%=b.getIdProdotto()%>">Modifica</a></div>
										</div>
