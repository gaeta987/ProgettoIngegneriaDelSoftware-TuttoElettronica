...
if(userRoles != null || userRoles.equalsIgnoreCase("gestoreRiparazioni") || userRoles.equals("admin")){
    ...
    ArrayList<ProdottoInRiparazioneBean> prodotti = (ArrayList<ProdottoInRiparazioneBean>)request.getAttribute("prodottiInRiparazione");
  
    %>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Modifica Stato Riparazione</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<!-- Cart -->
		...
		<!-- Cart -->
<form action="ModificaRiparazioneControl">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						...
						%>
						<input type="hidden" name="idPrenotazione" value="<%=prodotti.get(i).getIdPrenotazione() %>">
						<div class="cart_items">
							<ul class="cart_list">
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Codice Fiscale Cliente</div>
											<div class="cart_item_text"><%=prodotti.get(i).getCodiceCliente()%></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Codice Prodotto</div>
											<div class="cart_item_text"><%=prodotti.get(i).getIdProdotto() %></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Stato della riparazione</div>
											<div class="cart_item_text"><%=prodotti.get(i).getStatoRiparazione() %></div>
										</div>
										
											<%
						Date dataFine = prodotti.get(i).getDataFineLavoro();
						if(dataFine != null){
						%>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data fine lavoro</div>
											<div class="cart_item_text"><%=dataFine %></div>
										</div>											
						<%
						}else{
						%>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data fine lavoro</div>
											<div class="cart_item_text">Data non definita</div>
										</div>
							...
							<ul class="cart_list">
								<li class="cart_item clearfix">
									...
									<div class="cart_item_color cart_info_col" id="Modifica1">
											...
											<div class="cart_item_text"><a href="#" onclick="visualizza1('NuovoValore1'); return false">Modifica Data</a></div>
										</div>
										
											<div class="cart_item_color cart_info_col" id="NuovoValore1"  style="display: none;">
												<div class="cart_item_title"></div>
												<div class="cart_item_text"><input type="date" name="data" placeholder="Inserisci nuova data"></div>
											</div>
											<div class="cart_item_color cart_info_col" id="Modifica">
											<div class="cart_item_title"></div>
											<div class="cart_item_text"><a href="#" onclick="visualizza('NuovoValore'); return false">Modifica Stato</a></div>
										</div>
	    
											<div class="cart_item_color cart_info_col" id="NuovoValore"  style="display: none;">
												<div class="cart_item_title"></div>
												<div class="cart_item_text"><select name="stato">
