...
if(userRoles != null || userRoles.equalsIgnoreCase("gestoreProdotti") || userRoles.equals("admin")){
   ...
   ProdottoInMagazzinoBean prodotto = (ProdottoInMagazzinoBean)request.getAttribute("prodottoDaModificare");
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						<div class="cart_title"><%=prodotto.getNome() %></div>
								...
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Quantità Presente</div>
											<div class="cart_item_text"><%=prodotto.getQuantitaInMagazzino() %></div>
										</div>	
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Nuova Quantità</div>
											<div class="cart_item_text"><input type="number" name="quantita"></div>
										</div>
									</div>
								</li>
							</ul>
						...
						<div class="cart_items">
							<ul class="cart_list">
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Prezzo Presente</div>
											<div class="cart_item_text"><%=prodotto.getCosto() %></div>
										</div>	
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Nuovo Prezzo</div>
