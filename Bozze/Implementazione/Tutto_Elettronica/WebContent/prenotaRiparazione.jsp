<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    Date[] date = (Date[])request.getSession().getAttribute("datePrenotazioni");
    %>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Prenota Riparazione</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	if(date[0].before(data)){
		date[0] = null;
	}
	if(date[1].before(data)){
		date[1] = null;
	}
	if(date[2].before(data)){
		date[2] = null;
	}
	...
	<form action="PrenotazioneRiparazioneControl">
					...
					<div class="cart_container">
								...
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Seleziona Data</div>
											<div class="cart_item_text"><select name="dateRiparazioni">
																				<%
																				if(date[0] != null){
																				%>
										...
										<div class="cart_item_total cart_info_col">
											<div class="cart_item_title">Descrizione del problema</div>
											<div class="cart_item_text"><textarea rows="5" cols="20" name="descrizione"></textarea></div>
										</div>
									</div>
								</li>
							</ul>
						...
						<input type="hidden" name="action" value="acquista">
							<div class="cart_buttons">
								<button type="submit" class="button cart_button_checkout" onClick="return validateRiparazione(this.form)">Invia</button>
							</div>
						</form>
					</div>
				</div>
