...
<html lang="en">
<head>
<title>Modifica Date Disponibili</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<!-- Cart -->
		...
		<!-- Cart -->
<form action="ModificaDateControl">
								...
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data 1</div>
											<div class="cart_item_text"><%=date[0] %></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data 2</div>
											<div class="cart_item_text"><%=date[1] %></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data 3</div>
											<div class="cart_item_text"><%=date[2] %></div>
										</div>
									</div>
								</li>
							</ul>
							...
							<ul class="cart_list">
								<li class="cart_item clearfix">
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data 1</div>
											<div class="cart_item_text"><input type="date" name="data1"></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data 2</div>
											<div class="cart_item_text"><input type="date" name="data2"></div>
										</div>
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Data 3</div>
											<div class="cart_item_text"><input type="date" name="data3"></div>
										</div>
