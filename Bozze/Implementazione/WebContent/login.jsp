			...
			<div id="subLogin">
				<div id="registrazione">
					<fieldset>
						...
						<form name="form1" action="RegistraServlet" method="post">
							<input type="hidden" name="ruolo" value="cliente">
							<input type="hidden" name="action" value="registrazione">
							<div class="tableRow2">
							<p>Insert Username: </p><p><input type="text" required name="user"></p>
							</div>
							<div class="tableRow2">
							...
							<div class="tableRow2">
							<p>Insert data di nascita: </p><p><input type="text"  required placeholder="30/04/2000" name="data"></p>
							</div>
							<div class="tableRow2">
							...
							<div class="tableRow2">
							<p>Insert via: </p><p><input type="text" required placeholder="roma"name="via"></p>
							</div>
							<div class="tableRow2">
							<p>Insert città: </p><p><input type="text" required placeholder="Napoli"name="city"></p>
							</div>
							<div class="tableRow2">
							<p>Insert cap: </p><p><input type="number" min="0" required placeholder="80039" name="cap"></p>
							</div>
							<div class="tableRow2">
							<p></p>
