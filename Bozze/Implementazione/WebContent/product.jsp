<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    ProdottoInMagazzinoBean prodotto = (ProdottoInMagazzinoBean) session.getAttribute("prodottoCliccato");
    if(prodotto == null){
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="DisplayImage?url=<%=prodotto.getImmagine() %>" alt=""></div>
				</div>

				<!-- Description -->
				<div class="col-lg-5 order-3">
					<div class="product_description">
						<div class="product_category" style="text-transform: capitalize;"><%=prodotto.getTipo()%></div>
						<div class="product_name" style="text-transform: capitalize;"><%=prodotto.getNome() %></div>
						<div class="product_category" style="text-transform: capitalize;"><%=prodotto.getMarca()%></div>
						<div class="rating_r rating_r_4 product_rating"><i></i><i></i><i></i><i></i><i></i></div>
						<div class="product_text" style="text-transform: capitalize;"><p><%=prodotto.getDescrizione() %></p></div>
							...
							<form action="CartControl">
								<div class="clearfix" style="z-index: 1000;">
									...
									<div class="product_quantity clearfix">
										...
										<input id="quantity_input" type="text" pattern="[0-9]*" value="1" name="quantity" max="<%=prodotto.getQuantitaInMagazzino()%>">
								...
								<div class="product_price"><%=prodotto.getCosto() %></div>
